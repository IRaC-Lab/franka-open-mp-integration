...
class HumanRobotSafetySystem:
    def __init__(self):
        ...
        # 파라미터
        self.emergency_distance = rospy.get_param('~emergency_distance', 1.80)  # DECELERATION
        self.release_distance   = rospy.get_param('~release_distance',   2.00)  # CLEAR
        self.warning_distance   = rospy.get_param('~warning_distance',   2.00)  # WARNING
